...
public class SolarSystem {
    ...
    public void addEarth(){
        Planet earth = new Planet(152.1, 0.0, 5.97e24, 0.0, 0.0,152.1,0.017,365.2,0.0,0.0,152.1, 12756.0 , "src/images/Earth.png", "earth");
        addPlanet(earth);
    }
    public void addMercury() {
        Planet mercury = new Planet(69.8, 0.0, 0.330e24, 0.0, 0.0, 69.8, 0.206, 87.97, 0.0, 0.0, 69.8, 4879.0, "src/images/Mercury.png", "mercury");
        addPlanet(mercury);
    }

    public void addVenus() {
        Planet venus = new Planet(108.9, 0.0, 4.87e24, 0.0, 0.0, 108.9, 0.007, 224.7, 0.0, 0.0, 108.9, 12104.0, "src/images/Venus.png", "venus");
        addPlanet(venus);
    }

    public void addMars() {
        Planet mars = new Planet(249.3, 0.0, 0.642e24, 0.0, 0.0, 249.3, 0.093, 687.0, 0.0, 0.0, 249.3, 6792.0, "src/images/Mars.png", "mars");
        addPlanet(mars);
    }

    public void addJupiter() {
        Planet jupiter = new Planet(816.4, 0.0, 1898e24, 0.0, 0.0, 816.4, 0.049, 4331, 0.0, 0.0, 816.4, 142984.0, "src/images/Jupiter.png", "jupiter");
        addPlanet(jupiter);
    }

    public void addSaturn() {
        Planet saturn = new Planet(1506.5, 0.0, 568e24, 0.0, 0.0, 1506.5, 0.056, 10747, 0.0, 0.0, 1506.5, 120536.0, "src/images/Saturn.png", "saturn");
        addPlanet(saturn);
    }

    public void addUranus() {
        Planet uranus = new Planet(3001.4, 0.0, 86.8e24, 0.0, 0.0, 3001.4, 0.046, 30589, 0.0, 0.0, 3001.4, 51118.0, "src/images/Uranus.png", "uranus");
        addPlanet(uranus);
    }

    public void addNeptune() {
        Planet neptune = new Planet(4558.9, 0.0, 102e24, 0.0, 0.0, 4558.9, 0.010, 59800, 0.0, 0.0, 4458.9, 49528.0, "src/images/Neptune.png", "neptune");
        addPlanet(neptune);
    }

    public void addPluto() {
        Planet pluto = new Planet(7375.9, 0.0, 0.0130e24, 0.0, 0.0, 7375.9, 0.248, 90560, 0.0, 0.0, 7375.9, 2376.0, "src/images/Pluto.png", "pluto");
        addPlanet(pluto);
    }
